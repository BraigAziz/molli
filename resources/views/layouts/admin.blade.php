                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="nav-link" href="{{Route::has('addProduct')? route('addProduct') : 'admin/addProduct' }}">Add product</a></li>
                            <li><a class="nav-link" href="{{Route::has('admin.products')? route('admin.products') : 'admin/products' }}">All products</a></li>
                        </ul>
                    </li>
                    <li class="dropdown">
